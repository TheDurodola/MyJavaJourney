...
4. Exit
	...
	switch(mainMenuInput){
		...
		case 1:
			addToEmployeePayroll(employeeRecords, index);
			break;
		
		case 2:
			viewEmployeePayroll(employeeRecords);
			break;
...
static String[][] addToEmployeePayroll(String [][] employeeRecords, int index){
Scanner input = new Scanner(System.in);
...
static void viewEmployeePayroll(String[][] employeeRecords ){
